...
package com.onetwofivegames.spherestestbenchandroidvr.resources;
...
import com.onetwofivegames.spherestestbenchandroidvr.JavaLog;
...
public class FileBackend {
	...
	public int loadTexture(String imageName) {
		...
		{
			JavaLog.fatal(FileBackend.TAG, "Texture loading ran into exception: " + ioe.toString());
		}
